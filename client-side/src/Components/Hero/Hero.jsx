    ...
    return(
        <div className="lg:px-0 px-4">
            <div className=' container  flex flex-col md:flex-col w-full lg:flex lg:w-full lg:flex-row items-center relative'>
                <div data-aos="fade-right" className='w-full flex-col items-center lg:w-1/2 lg:text-left text-center space-y-5'>
                ...
                <img data-aos="fade-left" className='w-1/2 md:[75%] lg:w-1/2' src={hero} alt="" />
                <div className='absolute w-[50%] h-[70vh] bg-[#9fddc3] right-20 blur-3xl -z-20 rounded-full opacity-30'></div>
            </div>
            <div data-aos="slide-up" className="grid grid-cols-2 text-center bg-[#EBFBF3] py-12 mt-[2rem] md:mt-[2rem] lg:mt-[4rem] mb-[3rem] lg:grid-cols-4 gap-4">
                <div>
